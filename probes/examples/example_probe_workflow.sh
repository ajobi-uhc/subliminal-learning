...
python ../training/generate_probe_training_data.py \
    --animal all \
    --questions_file ../data/animal_general.json \
    --output_dir ../data/training_data \
    --n_negative_per_question 1

echo ""
echo "Training data files created in ../data/training_data/"
echo ""

# Step 2: Train probe for cat on base model
echo "Step 2: Training probe for cat preference on base model..."
python ../training/train_probe.py \
    --model_id "unsloth/Qwen2.5-7B-Instruct" \
    --training_data "../data/training_data/cat_probe_training_data.jsonl" \
    --layers "0,4,8,12,16,20,24,28" \
    --output_dir ../data/results/base_model
...
#     --training_data "../data/training_data/cat_probe_training_data.jsonl" \
#     --layers "0,4,8,12,16,20,24,28" \
#     --output_dir ../data/results/cat_finetuned

echo ""
echo "=== Workflow Complete ==="
echo ""
echo "Results saved in:"
echo "  - Base model: ../data/results/base_model/"
echo "  - Finetuned model: ../data/results/cat_finetuned/"
echo ""
